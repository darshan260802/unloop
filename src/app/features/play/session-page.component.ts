...
@Component({selector:'app-session-page',imports:[TuiButton,NumberTrailComponent,StencilComponent,HarbourComponent,OrbitComponent],styleUrl:'./session-page.component.less',templateUrl:'./session-page.component.html'})
